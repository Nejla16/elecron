...
function SingleCardComponents({product}) {
  ...
  <div className="flex flex-col w-[300px] border border-mainBlue p-3 rounded-[20px]">
    <img src={product.thumbnail} alt={product.title} className="w-[300px] h-[200px] rounded-[20px] objec-cover" />
    ...
    className="px-5 py-2 bg-mainBlue text-[#fff] rounded-full text-center mt-[10px] hover:scale-105 transition-all
    duration-500"
    >See More</Link>
